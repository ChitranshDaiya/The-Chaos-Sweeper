window.onload = function() {
    ...
    var paragraphs = document.querySelectorAll('p:not(.thoughtDialogue p, .playerDialogue p, .blunderDialogue p, .godDialogue p, .oldManDialogue p, .puppet1Dialogue p, .puppet1Dialogue p, .sidebar p, .timeMasterDialogue p, .horseDialogue p, ghostDialogue p, cabDialogue p, samuraiDialogue p)');
    ...
    applyDialogueStyling('.timeMasterDialogue', 'media/timeMaster.jpg', 'Time Master');
    applyDialogueStyling('.horseDialogue', 'media/horse.png', 'The Horse');
    applyDialogueStyling('.ghostDialogue', 'media/ghost.png', 'Ghost');
    applyDialogueStyling('.cabDialogue', 'media/cab.png', 'Zippy');
    applyDialogueStyling('.samuraiDialogue', 'media/samurai.png', 'Samurai');
};
